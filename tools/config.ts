...
export const APP_TITLE            = 'ng2-dragula';
...
export const NPM_DEPENDENCIES = [
  ...
  { src: 'dragula/dist/dragula.min.js', inject: 'libs', dest: LIB_DEST },
  
  { src: 'dragula/dist/dragula.min.css', inject: true, dest: CSS_DEST }
...
export const APP_ASSETS = [
  { src: `${ASSETS_SRC}/css/example.css`, inject: true, dest: CSS_DEST }
];
